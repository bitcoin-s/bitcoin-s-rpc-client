package org.bitcoins.rpc.marshallers.blockchain.softforks

import org.bitcoins.rpc.bitcoincore.blockchain.softforks.{SoftForksImpl, RejectionProgress, EnforcementProgress, SoftForks}
 ...
 */
object SoftForkRPCMarshaller extends DefaultJsonProtocol with RPCMarshallerUtil {
  val idKey = "id"
