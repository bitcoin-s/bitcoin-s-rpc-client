...
import org.bitcoins.rpc.bitcoincore.networking.{NetworkInfo, NetworkInfoImpl, NetworkConnections}
 ...
 */
object NetworkRPCMarshaller extends DefaultJsonProtocol with RPCMarshallerUtil {
